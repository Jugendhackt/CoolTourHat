# NeoPixel library strandtest example# Author: Tony DiCola (tony@tonydicola.com)
#
...
LED_BRIGHTNESS = int(sys.argv[1])     # Set to 0 for darkest and 255 for brightest
...
def theaterChase(strip, color, wait_ms=75, iterations=10):
...
if __name__ == '__main__':
	...
	while True:
                try:
	                with open("/home/pi/state", "r") as sfile:
				s = json.load(sfile)
